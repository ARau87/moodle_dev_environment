...
/**
 * Strings for component 'qtype_chemdraw'
 *
 * @package    qtype
 * @subpackage chemdraw
...
// General strings
$string['pluginname'] = 'Chem Draw';
$string['pluginnamesummary'] = 'Allows the creation of questions that include drawing chemical structures with the JSME molecule editor.';
